...
```{r transform abundance table into presence-absence}
...
```{r standardize predictor variables}
...
```{r extended dissimilarities, eval=FALSE}
...
```{r MRM - simple regressions, eval=FALSE}
...
```{r set contrast reference in BioRegion}
...
```{r ordispider - PCoA in BioRegions}
